    ...
    <AnimatePresence>
      ...
      >
        <Card className="flex flex-col justify-center items-center w-9/12 h-96 md:w-6/12">
          <Heading align={"center"} className="text-gray-300">
            Connect Your Wallet
          </Heading>
          <Text className="mb-4" as="p" align={"center"}>
            <span className="font-parisienne text-3xl bg-gradient-to-r from-blue-500 to-red-500 bg-clip-text text-transparent hover:cursor-default">
              token-it
            </span>
